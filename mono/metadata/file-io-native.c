...
MonoBoolean
native_io_icall_System_IO_MonoIO_CreateDirectory (MonoString *path, gint32 *error)
{
	gboolean ret;
...
MonoBoolean
native_io_icall_System_IO_MonoIO_RemoveDirectory (MonoString *path, gint32 *error)
{
	gboolean ret;
...
MonoString *
native_io_icall_System_IO_MonoIO_FindNext (gpointer handle, gint32 *result_attr, gint32 *error)
{
...
int
native_io_icall_System_IO_MonoIO_FindClose (gpointer handle)
{
	IncrementalFind *ifh = handle;
	gint32 error;
...
MonoString *
native_io_icall_System_IO_MonoIO_GetCurrentDirectory (gint32 *error)
{
	MonoString *result;
	gunichar2 *buf;
	int len, res_len;
...
MonoBoolean
native_io_icall_System_IO_MonoIO_DeleteFile (MonoString *path, gint32 *error)
{
	gboolean ret;
...
gint32 
native_io_icall_System_IO_MonoIO_GetFileAttributes (MonoString *path, gint32 *error)
{
	gint32 ret;
...
gint32
native_io_icall_System_IO_MonoIO_GetFileType (HANDLE handle, gint32 *error)
{
	gboolean ret;
...
MonoBoolean
native_io_icall_System_IO_MonoIO_Close (HANDLE handle, gint32 *error)
{
	gboolean ret;
...
MonoBoolean
native_io_icall_System_IO_MonoIO_Flush (HANDLE handle, gint32 *error)
{
	gboolean ret;
...
gint64 
native_io_icall_System_IO_MonoIO_GetLength (HANDLE handle, gint32 *error)
{
	gint64 length;
	guint32 length_hi;
...
gint32
native_io_icall_System_IO_MonoIO_GetTempPath (MonoString **mono_name)
{
	gunichar2 *name;
	int ret;
...
HANDLE
native_io_icall_System_IO_MonoIO_get_ConsoleOutput ()
{
	return GetStdHandle (STD_OUTPUT_HANDLE);
}

HANDLE 
native_io_icall_System_IO_MonoIO_get_ConsoleInput ()
{
	return GetStdHandle (STD_INPUT_HANDLE);
}

HANDLE 
native_io_icall_System_IO_MonoIO_get_ConsoleError ()
{
